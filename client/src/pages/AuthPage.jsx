...
import { AlertCircle, BellRing, ChevronDown, Receipt, ShieldCheck, Wand2 } from "lucide-react";
                ...
                {bankOpen && (
                  <div className="disclosure-body stack-sm">
                    <p className="muted caption" style={{ margin: "0 0 4px" }}>
                      Shown inside payment reminders so debtors know where to pay.
                    </p>
      ...
      <aside className="auth-right" aria-hidden="true">
        <div className="auth-brand-panel">
          ...
          <p className="auth-vp-sub">
            Track every debt, remind every debtor, and watch the market — with an agent
            that prepares the work and lets you approve it.
          </p>

          <ul className="auth-benefits">
            <li>
              <span className="ab-ic"><Receipt size={16} /></span>
              Track debts and part-payments in one ledger
            </li>
            <li>
              <span className="ab-ic"><BellRing size={16} /></span>
              Reminders drafted and sent for you
            </li>
            <li>
              <span className="ab-ic"><ShieldCheck size={16} /></span>
